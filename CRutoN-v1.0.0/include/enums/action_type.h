/*==============================================================================
	...
	An enumeration for the different types of action.
...
\==============================================================================/
<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>*/
#ifndef ACTION_TYPE_H_
#define ACTION_TYPE_H_

enum ActionType
{
	PROP_VALUE_ASSIGNMENT = 0, ENUM_VALUE_ASSIGNMENT,
	EXECUTE_NON_D, EXECUTE, WAIT
};
