/*==============================================================================
	...
	An enumeration for the different types of precondition,

	File			: precondition_type.h
	Author			: Paul Gainer
	Created			: 13/12/2014
...
\==============================================================================/
<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>*/
#ifndef PRECONDITION_TYPE_H_
#define PRECONDITION_TYPE_H_

enum PreconditionType
{
	PROP_VALUE_CHECK = 0, ENUM_VALUE_CHECK, TIMING_CONSTRAINT
};
