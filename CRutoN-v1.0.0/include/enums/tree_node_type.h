/*==============================================================================
	...
	An enumeration for the different types of logical expression tree node.
...
\==============================================================================/
<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>*/
#ifndef TREE_NODE_TYPE_H_
#define TREE_NODE_TYPE_H_

enum TreeNodeType
{
	LEAF = 0, INTERNAL_AND, INTERNAL_OR, INTERNAL_NOT
};
